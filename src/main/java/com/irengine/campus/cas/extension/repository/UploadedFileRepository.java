...
public interface UploadedFileRepository extends CrudRepository<UploadedFile, Long>{
	...
	List<UploadedFile> findByEntityTypeAndEntityId(@Param("type") String type,@Param("entityType") String entityType,@Param("entityId") long entityId);
	...
	List<UploadedFile> findByEntityTypeAndEntityId(@Param("entityType") String entityType,@Param("entityId") long entityId);
	@Modifying
	...
	void deleteByTypeAndEntityTypeAndEntityId(@Param("type") String type, @Param("entityType") String entityType,
